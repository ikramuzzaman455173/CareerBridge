    ...
    <div className='mx-2 md:mx-8'>
      <div className="flex items-center justify-between h-16 border-b-[.5px] border-accent dark:border-gray-600">
        <div className="flex items-center justify-between flex-1">
          <a className="text-black dark:text-lightColor font-bold" href="/home">Job Management</a>
        ...
        <div className="hidden md:flex md:items-center">
          ...
          <button className="text-accent dark:text-secondary hover:bg-success hover:dark:bg-gray-600 px-3 py-2 rounded-full text-sm font-medium border-[.5px] border-accent dark:border-info ">
            <Switcher />
          </button>
