...
import "./Navbar.css";
import Switcher from "../../Hooks/ThemeSwitcher";
const Navbar = () => {
  return (
    <div className="mx-2 md:mx-8">
      <div className="flex items-center justify-between h-16 border-b-[.5px] border-accent dark:border-gray-600">
        <div className="flex items-center justify-between flex-1">
          <a
            className="text-black dark:text-primary-color font-bold"
            href="/home"
          >
            Job Management
          </a>
        ...
        <div className="hidden md:flex md:items-center">
          ...
          <a
            aria-current="page"
            className="duration-300 text-accent dark:text-secondary px-3 py-2 hov text-sm font-semibold"
            href="/home"
          >
            Home
          </a>
          <a
            className="duration-300 justify-center items-center flex text-accent dark:text-secondary hov hover:scale-105 px-3 py-2 text-sm font-semibold"
            href="/poster-seeker"
          >
            Job Poster/Seeker
          </a>
